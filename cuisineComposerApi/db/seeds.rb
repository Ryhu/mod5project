...
ShoppingCartIngredient.create(ingredient_id: bread.id, shopping_cart_id: 1)
ShoppingCartIngredient.create(ingredient_id: 2, shopping_cart_id: 1)
ShoppingCartIngredient.create(ingredient_id: 7, shopping_cart_id: 1)
ShoppingCartIngredient.create(ingredient_id: 4, shopping_cart_id: 1)
